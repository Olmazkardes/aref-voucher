...
Seninle beraber \`${guild.memberCount}\` kişi olduk! Sunucumuzun \`Tagınız\` tagını adına katarak ailemizden biri olabilirsin.

Sunucunun yazı/ses kanallarına erişmek için soldaki ses kanallarının birisine gidip <@&RegisterYetkiliRolID> yetkilisine teyit vererek kayıt olabilirsin.
...
İyi vakit geçirmen dileği ile! **Sunucu İsimi /Aref**
...
`)
        ...
        hgkanal.send(`
        ${member} Adlı kullanıcı sunucumuza katıldı hesabı yeni olduğu için kullanıcıya şüpheli rolü verdim.
        `)
    }
});